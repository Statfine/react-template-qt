...
const textField = function(options, defaultParameters) {
  ...
  const actionName = (typeof options.buttonAction !== 'undefined') ? options.buttonAction.name : 'clear';
  const actionMethod = (typeof options.buttonAction !== 'undefined') ? options.buttonAction.method : defaultButtonAction;
  const showName = (typeof options.buttonShow !== 'undefined') ? options.buttonShow.name : 'canClear';
  const showMethod = (typeof options.buttonShow !== 'undefined') ? options.buttonShow.method : defaultButtonShow;
  ...
  resource.html =
    ...
    `<div class="bpp-field-wrapper" ${ 
      ...
      `<input id="smart-${  escapeHTML(resource.id)  }" type="text" name="${  escapeHTML(options.modelProperty)  }" ${ 
        canBeDisabled ? 'data-disable="isDisabled"' : '' 
      }${canBeHidden ? 'data-show="isHidden"' : '' 
      } />` +
