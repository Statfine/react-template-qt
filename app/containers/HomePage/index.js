...
export default function HomePage() {
  ...
  return (
    <Container>
      ...
      {logined ? (
        <ActionBtn type="primary" onClick={handleLogout}>
          退出
        </ActionBtn>
      ) : (
        <ActionBtn type="primary" onClick={handleLogin}>
          登录
        </ActionBtn>
      )}
      <ActionBtn type="primary" onClick={postFatherMessage}>
        发送message
      </ActionBtn>
      <ActionBtn type="primary" onClick={handelJumpDashboard}>
        面板
      </ActionBtn>
    </Container>
  );
