...
const emoticons = defaultEmoticons.map(item => require(`braft-extensions/dist/assets/${item}`)) // eslint-disable-line
...
function EditorPage() {
  ...
  return (
    <div className="editor-container" style={{ margin: '20px', border: '1px solid #e3e3e3' }}>
      <BraftEditor
        maxLength={100}
